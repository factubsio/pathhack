...
public class ItemDb
{
    ...
    static readonly Dictionary<AppearanceCategory, Appearance[]> Pools = new()
    {
        ...
        [AppearanceCategory.Rune] = [
            new("rune scribed KEN-TYR-ISA", ConsoleColor.Red),
            new("rune scribed KEN-TYR-SOL", ConsoleColor.Green),
            new("rune scribed KEN-TYR-FEHU", ConsoleColor.Blue),
            new("rune scribed KEN-TYR-GEBO", ConsoleColor.Cyan),
            new("rune scribed KEN-TYR-JERA", ConsoleColor.Magenta),
            new("rune scribed KEN-TYR-DAGAZ", ConsoleColor.Yellow),
            new("rune scribed KEN-ISA-SOL", ConsoleColor.White),
            new("rune scribed KEN-ISA-FEHU", ConsoleColor.DarkCyan),
            new("rune scribed KEN-ISA-GEBO", ConsoleColor.DarkYellow),
            new("rune scribed KEN-ISA-JERA", ConsoleColor.DarkMagenta),
            new("rune scribed KEN-ISA-DAGAZ", ConsoleColor.Red),
            new("rune scribed KEN-SOL-FEHU", ConsoleColor.Green),
            new("rune scribed KEN-SOL-GEBO", ConsoleColor.Blue),
            new("rune scribed KEN-SOL-JERA", ConsoleColor.Cyan),
            new("rune scribed KEN-SOL-DAGAZ", ConsoleColor.Magenta),
            new("rune scribed KEN-FEHU-GEBO", ConsoleColor.Yellow),
            new("rune scribed KEN-FEHU-JERA", ConsoleColor.White),
            new("rune scribed KEN-FEHU-DAGAZ", ConsoleColor.DarkCyan),
            new("rune scribed KEN-GEBO-JERA", ConsoleColor.DarkYellow),
            new("rune scribed KEN-GEBO-DAGAZ", ConsoleColor.DarkMagenta),
            new("rune scribed KEN-JERA-DAGAZ", ConsoleColor.Red),
            new("rune scribed TYR-ISA-SOL", ConsoleColor.Green),
            new("rune scribed TYR-ISA-FEHU", ConsoleColor.Blue),
            new("rune scribed TYR-ISA-GEBO", ConsoleColor.Cyan),
            new("rune scribed TYR-ISA-JERA", ConsoleColor.Magenta),
            new("rune scribed TYR-ISA-DAGAZ", ConsoleColor.Yellow),
            new("rune scribed TYR-SOL-FEHU", ConsoleColor.White),
            new("rune scribed TYR-SOL-GEBO", ConsoleColor.DarkCyan),
            new("rune scribed TYR-SOL-JERA", ConsoleColor.DarkYellow),
            new("rune scribed TYR-SOL-DAGAZ", ConsoleColor.DarkMagenta),
            new("rune scribed TYR-FEHU-GEBO", ConsoleColor.Red),
            new("rune scribed TYR-FEHU-JERA", ConsoleColor.Green),
            new("rune scribed TYR-FEHU-DAGAZ", ConsoleColor.Blue),
            new("rune scribed TYR-GEBO-JERA", ConsoleColor.Cyan),
            new("rune scribed TYR-GEBO-DAGAZ", ConsoleColor.Magenta),
            new("rune scribed TYR-JERA-DAGAZ", ConsoleColor.Yellow),
            new("rune scribed ISA-SOL-FEHU", ConsoleColor.White),
            new("rune scribed ISA-SOL-GEBO", ConsoleColor.DarkCyan),
            new("rune scribed ISA-SOL-JERA", ConsoleColor.DarkYellow),
            new("rune scribed ISA-SOL-DAGAZ", ConsoleColor.DarkMagenta),
            new("rune scribed ISA-FEHU-GEBO", ConsoleColor.Red),
            new("rune scribed ISA-FEHU-JERA", ConsoleColor.Green),
            new("rune scribed ISA-FEHU-DAGAZ", ConsoleColor.Blue),
            new("rune scribed ISA-GEBO-JERA", ConsoleColor.Cyan),
            new("rune scribed ISA-GEBO-DAGAZ", ConsoleColor.Magenta),
            new("rune scribed ISA-JERA-DAGAZ", ConsoleColor.Yellow),
            new("rune scribed SOL-FEHU-GEBO", ConsoleColor.White),
            new("rune scribed SOL-FEHU-JERA", ConsoleColor.DarkCyan),
            new("rune scribed SOL-FEHU-DAGAZ", ConsoleColor.DarkYellow),
            new("rune scribed SOL-GEBO-JERA", ConsoleColor.DarkMagenta),
            new("rune scribed SOL-GEBO-DAGAZ", ConsoleColor.Red),
            new("rune scribed SOL-JERA-DAGAZ", ConsoleColor.Green),
            new("rune scribed FEHU-GEBO-JERA", ConsoleColor.Blue),
            new("rune scribed FEHU-GEBO-DAGAZ", ConsoleColor.Cyan),
            new("rune scribed FEHU-JERA-DAGAZ", ConsoleColor.Magenta),
            new("rune scribed GEBO-JERA-DAGAZ", ConsoleColor.Yellow),
        ],
    };
