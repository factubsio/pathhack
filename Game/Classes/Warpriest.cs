...
public static class Fervor
{
    ...
    public class EnhanceWeaponAction() : ActionBrick("Fervor: Enhance Weapon")
    {
        ...
        public override void Execute(IUnit unit, object? data, Target target, object? plan = null)
        {
            ...
            {
                case "Flaming":
                    weapon.AddFact(WeaponDamageRider.FlamingD8, null, 12);
                    break;
                case "Freeze":
                    weapon.AddFact(WeaponDamageRider.FreezeD8, null, 12);
                    break;
                case "Shock":
                    weapon.AddFact(WeaponDamageRider.ShockD8, null, 12);
                    break;
                case "Holy":
                    weapon.AddFact(WeaponDamageRider.HolyD8, null, 12);
                    break;
                case "Unholy":
                    weapon.AddFact(WeaponDamageRider.UnholyD8, null, 12);
                    break;
            }
        }
    }
...
public static partial class ClassDefs
{
    public static readonly List<SpellBrickBase> WarpriestList = [
        ...
        BasicLevel1Spells.ProtFromGood,
        BasicLevel1Spells.ProtFromLaw,
        BasicLevel1Spells.ProtFromChaos,
        BasicLevel2Spells.ScorchingRay,
        BasicLevel2Spells.SoundBurst,
        BasicLevel2Spells.ResistFire,
        BasicLevel2Spells.ResistCold,
        BasicLevel2Spells.ResistShock,
        BasicLevel2Spells.ResistAcid,
        BasicLevel2Spells.DelayPoison,
        BasicLevel2Spells.HoldPerson,
        BasicLevel2Spells.DimensionDoor,
        BasicLevel3Spells.Fireball,
        BasicLevel3Spells.VampiricTouch,
        BasicLevel3Spells.FlyLesser,
        BasicLevel3Spells.Heroism,
        BasicLevel3Spells.FalseLife,
        BasicLevel3Spells.ProtectFire,
        BasicLevel3Spells.ProtectCold,
        BasicLevel3Spells.ProtectShock,
        BasicLevel3Spells.ProtectAcid,
    ];

    public const string WarpriestId = "warpriest";

    private static FeatSelection[] SpellSelection => [
    ...
    public static ClassDef Warpriest => new()
    {
        id = WarpriestId,
        Name = "Warpriest",
        Description = "Warpriests are divine gishes (WISDOM).\n\nYou get extra bonuses for using your starting weapon's type.\n\nYou get spellcasting; use it!\n\nYou get self buffs through blessings.",
        HpPerLevel = 8,
        ...
        Progression = [
            ...
            null, // 6
            new() { Grants = [new GrantPool("spell_l1", 1, 20)], Selections = SpellSelection }, // 7
            null, // 8
            new() { Grants = [new GrantPool("spell_l3", 1, 60)], Selections = SpellSelection }, // 9
            new() { Grants = [new GrantPool("spell_l2", 1, 40)] }, // 10
            new() { Selections = SpellSelection}, // 11
            new() { Grants = [new GrantPool("spell_l3", 1, 60)] }, // 12
            new() { Grants = [new GrantPool("spell_l4", 1, 100)], Selections = SpellSelection }, // 13
            new() { Grants = [new GrantPool("spell_l1", 1, 20)] }, // 14
            new() { Grants = [new GrantPool("spell_l2", 1, 40)], Selections = SpellSelection }, // 15
            new() { Grants = [new GrantPool("spell_l3", 1, 60)] }, // 16
            new() { Grants = [new GrantPool("spell_l5", 1, 150)], Selections = SpellSelection }, // 17
            new() { Grants = [new GrantPool("spell_l4", 1, 100)] }, // 18
            new() { Selections = SpellSelection }, // 19
            null, // 20
        ],
