...
public static partial class MundaneArmory
{
    ...
    public static readonly WeaponDef Greatclub = new()
    {
        ...
        Name = "greatclub",
        BaseDamage = d(10),
        Style = WeaponStyle.Impact,
        Grip = WeaponGrip.Great,
    ...
    public static readonly ArmorDef LeatherArmor = new()
    {
        ...
        ArmorType = ArmorTypes.LeatherArmor,
        ACBonus = 1,
        DexCap = 4,
    ...
    public static readonly ArmorDef ChainShirt = new()
    {
        ...
        Name = "chain shirt",
        Proficiency = Proficiencies.LightArmor,
        ArmorType = ArmorTypes.ChainShirt,
        ACBonus = 2,
        DexCap = 3,
        CheckPenalty = -1,
    ...
    public static readonly ArmorDef HideArmor = new()
    {
        ...
        ArmorType = ArmorTypes.HideArmor,
        ACBonus = 3,
        DexCap = 2,
        CheckPenalty = -2,
        Glyph = new(ItemClasses.Armor, ConsoleColor.DarkYellow),
    ...
    public static readonly ArmorDef SplintMail = new()
    {
        ...
        ArmorType = ArmorTypes.SplintMail,
        ACBonus = 4,
        DexCap = 1,
        CheckPenalty = -3,
    ...
    public static readonly ArmorDef FullPlate = new()
    {
        ...
        Name = "full plate",
        Proficiency = Proficiencies.HeavyArmor,
        ArmorType = ArmorTypes.FullPlate,
        ACBonus = 6,
        DexCap = 0,
        CheckPenalty = -3,
